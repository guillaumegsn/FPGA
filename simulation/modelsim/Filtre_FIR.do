...
add wave -divider
add wave -color aquamarine -height 120 -decimal -format analog-step -min -127 -max +127 entree
...
#add wave -color pink   		-height 20 	-decimal 	FIR_pkg/REG_Sortie
add wave -divider

add wave -color aquamarine -height 120 -decimal -format analog-step -min -127 -max +127 sortie

add wave -color lightgreen	-height 20	-decimal	sortie
